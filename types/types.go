...
// KhulnasoftPayload is a struct to map khulnasoft event json
type KhulnasoftPayload struct {
...
func (f KhulnasoftPayload) String() string {
	j, _ := json.Marshal(f)
	return string(j)
}

func (f KhulnasoftPayload) Check() bool {
...
type PromStatistics struct {
	Khulnasoft *prometheus.CounterVec
