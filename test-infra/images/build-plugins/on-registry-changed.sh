...
create_pr() {
    ...
    body=$'Updating README.md (automatically generated with build/registry). Made using the [build-plugins-on-registry-changed-postsubmit](https://github.com/khulnasoft/fanal/test-infra/blob/master/config/jobs/build-plugins/build-plugins.yaml) ProwJob. Do not edit this PR.\n\n/kind documentation\n\n/area documentation'
...
# Meant to be run in the https://github.com/khulnasoft/plugins repository.
# $1: path of the file containing the token
main() {
    # Checks
    check_program "gpg"
