...
cd /home/prow/go/src/github.com/khulnasoft/fanal/test-infra/prow/update-jobs
...
aws eks --region eu-west-1 update-kubeconfig --name fanal-prow-test-infra

echo "******************************************************"
echo "Running job update"
echo "******************************************************"

bin/update-jobs --kubeconfig $KUBECONFIG --jobs-config-path /home/prow/go/src/github.com/khulnasoft/fanal/test-infra/config/jobs
