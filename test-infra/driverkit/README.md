...
### Q: Fanal doesn't find the kernel module/ eBPF probe for my OS, what do I do?

A: You can generate and contribute configurations for your OS, as follows:

- [Fork](https://docs.github.com/en/get-started/quickstart/fork-a-repo) this [repository](https://github.com/khulnasoft/fanal/test-infra)
...
For more informations, please see https://khulnasoft.com/blog/fanal-prebuilt-drivers-new-distro/.
