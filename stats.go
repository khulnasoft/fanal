...
func getInitStats() *types.Statistics {
	...
	stats = &types.Statistics{
		...
		Khulnasoft:        expvar.NewMap("khulnasoft.priority"),
	...
	stats.Khulnasoft.Add(outputs.Emergency, 0)
	stats.Khulnasoft.Add(outputs.Alert, 0)
	stats.Khulnasoft.Add(outputs.Critical, 0)
	stats.Khulnasoft.Add(outputs.Error, 0)
	stats.Khulnasoft.Add(outputs.Warning, 0)
	stats.Khulnasoft.Add(outputs.Notice, 0)
	stats.Khulnasoft.Add(outputs.Informational, 0)
	stats.Khulnasoft.Add(outputs.Debug, 0)
	stats.Khulnasoft.Add(outputs.None, 0)
