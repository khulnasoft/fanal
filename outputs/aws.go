...
func (c *Client) InvokeLambda(khulnasoftpayload types.KhulnasoftPayload) {
	svc := lambda.New(c.AWSSession)

	f, _ := json.Marshal(khulnasoftpayload)
...
func (c *Client) SendMessage(khulnasoftpayload types.KhulnasoftPayload) {
...
func (c *Client) UploadS3(khulnasoftpayload types.KhulnasoftPayload) {
	f, _ := json.Marshal(khulnasoftpayload)
...
func (c *Client) PublishTopic(khulnasoftpayload types.KhulnasoftPayload) {
	...
	if c.Config.AWS.SNS.RawJSON {
		...
		msg = &sns.PublishInput{
			Message: aws.String(khulnasoftpayload.Output),
			MessageAttributes: map[string]*sns.MessageAttributeValue{
				"priority": {
					DataType:    aws.String("String"),
					StringValue: aws.String(khulnasoftpayload.Priority.String()),
				},
				"rule": {
					DataType:    aws.String("String"),
					StringValue: aws.String(khulnasoftpayload.Rule),
				},
				"source": {
					DataType:    aws.String("String"),
					StringValue: aws.String(khulnasoftpayload.Source),
				},
			},
			TopicArn: aws.String(c.Config.AWS.SNS.TopicArn),
		}
		...
		if len(khulnasoftpayload.Tags) != 0 {
			msg.MessageAttributes["tags"] = &sns.MessageAttributeValue{
				DataType:    aws.String("String"),
				StringValue: aws.String(strings.Join(khulnasoftpayload.Tags, ",")),
			}
		}
		if khulnasoftpayload.Hostname != "" {
			msg.MessageAttributes[Hostname] = &sns.MessageAttributeValue{
				DataType:    aws.String("String"),
				StringValue: aws.String(khulnasoftpayload.Hostname),
			}
		}
...
func (c *Client) SendCloudWatchLog(khulnasoftpayload types.KhulnasoftPayload) {
	...
	logevent := &cloudwatchlogs.InputLogEvent{
		Message:   aws.String(string(f)),
		Timestamp: aws.Int64(khulnasoftpayload.Time.UnixNano() / int64(time.Millisecond)),
	}
...
func (c *Client) PutRecord(khulnasoftPayLoad types.KhulnasoftPayload) {
