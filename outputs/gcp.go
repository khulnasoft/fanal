...
func (c *Client) GCPCallCloudFunction(khulnasoftpayload types.KhulnasoftPayload) {
...
func (c *Client) GCPPublishTopic(khulnasoftpayload types.KhulnasoftPayload) {
...
func (c *Client) UploadGCS(khulnasoftpayload types.KhulnasoftPayload) {
